...
CLASS z2ui5_cl_demo_app_031 IMPLEMENTATION.
  ...
  METHOD z2ui5_on_render_main.
    ...
    DATA(lv_xml) = |<mvc:View | && |\n| &&
                        ...
                        |       <Input id="loadingMinSeconds" width="8rem" type="Number" description="seconds" value="{ client->_bind(
                                                                                                                            mv_value ) }"/>| && |\n| &&
                        ...
                        |   </form:SimpleForm>  | && |\n| &&
                        |   <GenericTile class="sapUiTinyMarginBegin sapUiTinyMarginTop tileLayout" header="Country-Specific Profit Margin"  press="{ client->_event(
                                                                                                                                                          'POPUP' ) }"| && |\n| &&
                        ...
                        |   </GenericTile>| && |\n|  &&
                        |\n| &&
                        |   <GenericTile class="sapUiTinyMarginBegin sapUiTinyMarginTop tileLayout" header="Sales Fulfillment Application Title" press="{ client->_event(
                                                                                                                                                              'DATA' ) }"| && |\n| &&
