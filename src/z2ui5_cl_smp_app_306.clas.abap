...
CLASS z2ui5_cl_smp_app_306 IMPLEMENTATION.
  ...
  METHOD on_event.
        ...
        FIELD-SYMBOLS <temp6> LIKE LINE OF mt_picture_out.
        DATA temp7 LIKE sy-tabix.
        FIELD-SYMBOLS <temp8> LIKE LINE OF mt_picture.
    ...
    CASE client->get_event( ).
      ...
      WHEN `DISPLAY`.
        ...
        temp7 = sy-tabix.
        READ TABLE mt_picture_out WITH KEY selected = abap_true ASSIGNING <temp6>.
        sy-tabix = temp7.
        IF sy-subrc <> 0.
          ASSERT 1 = 0.
        ENDIF.
        ...
        temp9 = sy-tabix.
        READ TABLE mt_picture INDEX selected_picture-id ASSIGNING <temp8>.
        sy-tabix = temp9.
        IF sy-subrc <> 0.
          ASSERT 1 = 0.
        ENDIF.
