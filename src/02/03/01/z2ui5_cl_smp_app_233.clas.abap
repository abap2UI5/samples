"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.MultiComboBox/sample/sap.m.sample.MultiComboBoxWrapping
"! Suggestions wrap automatically when longer then the dropdown width
CLASS z2ui5_cl_smp_app_233 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_233 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.MultiComboBox/sample/sap.m.sample.MultiComboBoxWrapping` ).
