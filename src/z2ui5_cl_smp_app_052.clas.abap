...
CLASS z2ui5_cl_smp_app_052 IMPLEMENTATION.
  ...
  METHOD popover_display.
    ...
    CLEAR temp1.
    INSERT `btn_details` INTO TABLE temp1.
  ...
  METHOD view_display.
    ...
    INSERT `${PRODUCT}` INTO TABLE temp3.
    lo_cells->tag( `Link`
        )->a( n = `text`  v = `{PRODUCT}`
        )->a( n = `press` v = client->_event( val = `POPOVER_DETAIL` t_arg = temp3 )
        )->a( n = `id`    v = `link` ).
    lo_cells->tag( `Text`
  ...
  METHOD set_data.
    ...
    DATA temp5 TYPE z2ui5_cl_smp_app_052=>ty_t_tab.
      DATA temp6 TYPE ty_t_tab.
    ...
    DO 8 TIMES.
      ...
      temp7-create_date = `01.01.2023`.
      temp7-create_by = `Hannah`.
      temp7-storage_location = `AREA_001`.
      temp7-quantity = 90.
      INSERT temp7 INTO TABLE temp6.
      temp7-product = `table2`.
      temp7-create_date = `01.01.2023`.
      temp7-create_by = `Julia`.
      temp7-storage_location = `AREA_001`.
      temp7-quantity = 110.
      INSERT temp7 INTO TABLE temp6.
      INSERT LINES OF temp6 INTO TABLE mt_table.
    ENDDO.
