...
CLASS z2ui5_cl_sample_000 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `framework` header = `Select-Options I` sub = `` app = `z2ui5_cl_demo_app_056` )
      ...
      ( group = `framework` header = `z2ui5_cl_demo_app_126` sub = `App in App II` app = `z2ui5_cl_demo_app_126` )
      ( group = `framework` header = `z2ui5_cl_demo_app_132` sub = `App in App II` app = `z2ui5_cl_demo_app_132` )
      ( group = `framework` header = `z2ui5_cl_demo_app_184` sub = `App in App II` app = `z2ui5_cl_demo_app_184` )
      ...
      ( group = `framework with action` header = `Frontend Infos` sub = `` app = `z2ui5_cl_demo_app_122` )
      ( group = `framework with action` header = `Hide/show Soft Keyboard` sub = `` app = `z2ui5_cl_demo_app_352` )
      ( group = `framework with action` header = `Tab Title` sub = `` app = `z2ui5_cl_demo_app_125` )
      ...
      ( group = `framework with action` header = `New Tab` sub = `Open an URL in a new tab` app = `z2ui5_cl_demo_app_073` )
      ( group = `framework with action` header = `Timer II` sub = `Set Loading Indicator while Server Request` app = `z2ui5_cl_demo_app_064` )
      ( group = `framework with action` header = `URL Helper` sub = `Trigger a phone's native apps like Email, Telephone and SMS` app = `z2ui5_cl_demo_app_316` )
