...
CLASS z2ui5_cl_smp_app_070 IMPLEMENTATION.
  ...
  METHOD set_data.
    ...
    temp4-selkz = abap_false.
    temp4-row_id = `1`.
    temp4-product = `table`.
    temp4-create_date = `01.01.2023`.
    temp4-create_by = `Olaf`.
    ...
    temp4-waers = `EUR`.
    temp4-process = `10`.
    temp4-process_state = `None`.
    INSERT temp4 INTO TABLE temp3.
    temp4-selkz = abap_false.
    temp4-row_id = `2`.
    temp4-product = `chair`.
    temp4-create_date = `01.01.2022`.
    temp4-create_by = `Karlo`.
    temp4-storage_location = `AREA_001`.
    temp4-quantity = 123.
    temp4-meins = `ST`.
    temp4-price = `2000.55`.
    temp4-waers = `USD`.
    temp4-process = `20`.
    temp4-process_state = `Warning`.
    INSERT temp4 INTO TABLE temp3.
    temp4-selkz = abap_false.
    temp4-row_id = `3`.
    temp4-product = `sofa`.
    temp4-create_date = `01.05.2021`.
    temp4-create_by = `Elin`.
    temp4-storage_location = `AREA_002`.
    temp4-quantity = 700.
    temp4-meins = `ST`.
    temp4-price = `3000.11`.
    temp4-waers = `CNY`.
    temp4-process = `30`.
    temp4-process_state = `Success`.
    INSERT temp4 INTO TABLE temp3.
    temp4-selkz = abap_false.
    temp4-row_id = `4`.
    ...
    temp4-waers = `USD`.
    temp4-process = `40`.
    temp4-process_state = `Information`.
    INSERT temp4 INTO TABLE temp3.
    temp4-selkz = abap_false.
    temp4-row_id = `5`.
    temp4-product = `printer`.
    temp4-create_date = `01.01.2023`.
    temp4-create_by = `Renate`.
    temp4-storage_location = `AREA_003`.
    temp4-quantity = 90.
    temp4-meins = `ST`.
    temp4-price = `5000.47`.
    temp4-waers = `EUR`.
  ...
  METHOD set_search.
      ...
      DATA temp5 LIKE LINE OF lt_all.
