...
CLASS ltcl_unit_test IMPLEMENTATION.
  METHOD test_raise.
        DATA lx TYPE REF TO z2ui5_cx_sample_error.
    ...
    TRY.
      ...
      CATCH z2ui5_cx_sample_error INTO lx.
  ...
  METHOD test_raise_with_prev.
    ...
    DATA lx_prev TYPE REF TO z2ui5_cx_sample_error.
        DATA lx TYPE REF TO z2ui5_cx_sample_error.
        DATA lv_text TYPE string.
        DATA temp1 TYPE xsdboolean.
        DATA temp2 TYPE xsdboolean.
    CREATE OBJECT lx_prev TYPE z2ui5_cx_sample_error EXPORTING val = `previous error`.
  ...
  METHOD test_chain_texts.
    ...
    DATA lx_inner TYPE REF TO z2ui5_cx_sample_error.
    DATA lx_middle TYPE REF TO z2ui5_cx_sample_error.
    DATA lx_outer TYPE REF TO z2ui5_cx_sample_error.
    DATA lv_text TYPE string.
    DATA temp3 TYPE xsdboolean.
    DATA temp4 TYPE xsdboolean.
    DATA temp5 TYPE xsdboolean.
    CREATE OBJECT lx_inner TYPE z2ui5_cx_sample_error EXPORTING val = `inner`.
    
    CREATE OBJECT lx_middle TYPE z2ui5_cx_sample_error EXPORTING val = `middle` previous = lx_inner.
    
    CREATE OBJECT lx_outer TYPE z2ui5_cx_sample_error EXPORTING val = `outer` previous = lx_middle.
