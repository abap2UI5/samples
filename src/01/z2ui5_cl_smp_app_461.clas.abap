...
CLASS z2ui5_cl_smp_app_461 IMPLEMENTATION.
  ...
  METHOD on_event.
      ...
      DATA temp2 TYPE string.
          DATA temp5 TYPE i.
          FIELD-SYMBOLS <temp10> LIKE LINE OF lt_drag.
          DATA temp11 LIKE sy-tabix.
          DATA lv_from_root TYPE i.
          DATA temp6 TYPE i.
          FIELD-SYMBOLS <temp12> LIKE LINE OF lt_drag.
          DATA temp13 LIKE sy-tabix.
          DATA lv_from_child TYPE i.
          DATA temp7 TYPE i.
          FIELD-SYMBOLS <temp14> LIKE LINE OF lt_drop.
          DATA temp15 LIKE sy-tabix.
          DATA lv_to_root TYPE i.
          DATA ls_child TYPE z2ui5_cl_smp_app_461=>ty_s_child.
          FIELD-SYMBOLS <temp16> LIKE LINE OF t_nodes.
          DATA temp17 LIKE sy-tabix.
          FIELD-SYMBOLS <temp3> LIKE LINE OF <temp16>-nodes.
    ...
    IF client->get_event( ) = `MOVE_NODE`.
      ...
      TRY.
          ...
          temp11 = sy-tabix.
          READ TABLE lt_drag INDEX lv_drag_lines - 2 ASSIGNING <temp10>.
          sy-tabix = temp11.
          IF sy-subrc <> 0.
            ASSERT 1 = 0.
          ENDIF.
          ...
          temp13 = sy-tabix.
          READ TABLE lt_drag INDEX lv_drag_lines ASSIGNING <temp12>.
          sy-tabix = temp13.
          IF sy-subrc <> 0.
            ASSERT 1 = 0.
          ENDIF.
          ...
          temp15 = sy-tabix.
          READ TABLE lt_drop INDEX lv_drop_lines ASSIGNING <temp14>.
          sy-tabix = temp15.
          IF sy-subrc <> 0.
            ASSERT 1 = 0.
          ENDIF.
          ...
          temp17 = sy-tabix.
          READ TABLE t_nodes INDEX lv_from_root ASSIGNING <temp16>.
          sy-tabix = temp17.
          IF sy-subrc <> 0.
            ASSERT 1 = 0.
          ENDIF.
          ...
          temp10 = sy-tabix.
          READ TABLE <temp16>-nodes INDEX lv_from_child ASSIGNING <temp3>.
          sy-tabix = temp10.
          IF sy-subrc <> 0.
            ASSERT 1 = 0.
          ENDIF.
