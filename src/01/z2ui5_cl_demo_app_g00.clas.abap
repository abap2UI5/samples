...
CLASS z2ui5_cl_demo_app_g00 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `Basic I` header = `EXPERIMENTAL` sub = `OData - Switch default Model` app = `z2ui5_cl_demo_app_314` )
      ...
      ( group = `Basic II` header = `Popup` sub = `Aggregation binding to the selected row (element bind)` app = `z2ui5_cl_demo_app_470` )
