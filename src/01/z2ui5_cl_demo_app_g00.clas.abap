...
CLASS z2ui5_cl_demo_app_g00 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `Basic II` header = `Focus` sub = `Focus Aggregations` app = `z2ui5_cl_demo_app_421` )
      ...
      ( group = `Basic II` header = `Navigation` sub = `Routing modes (default / fresh / keep)` app = `z2ui5_cl_demo_app_468` )
