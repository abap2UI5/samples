...
CLASS z2ui5_cl_demo_app_g00 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `Basic I` header = `Browser` sub = `Clipboard (A)` app = `z2ui5_cl_demo_app_325` )
      ( group = `Basic I` header = `Browser` sub = `Hide/show Soft Keyboard (A)` app = `z2ui5_cl_demo_app_352` )
      ( group = `Basic I` header = `Browser` sub = `Logout (A)` app = `z2ui5_cl_demo_app_361` )
      ( group = `Basic I` header = `Browser` sub = `Open an URL in a new tab (A)` app = `z2ui5_cl_demo_app_073` )
      ( group = `Basic I` header = `Browser` sub = `Open Telephon, Email usw (A)` app = `z2ui5_cl_demo_app_316` )
      ( group = `Basic I` header = `Browser` sub = `Title (A)` app = `z2ui5_cl_demo_app_125` )
      ( group = `Basic I` header = `CSS` sub = `Cell Coloring` app = `z2ui5_cl_demo_app_305` )
      ( group = `Basic I` header = `CSS` sub = `Flex Box with Navigation Examples` app = `z2ui5_cl_demo_app_255` )
      ( group = `Basic I` header = `CSS` sub = `Send your own CSS to the frontend` app = `z2ui5_cl_demo_app_050` )
      ...
      ( group = `Basic I` header = `Formatter` sub = `ABAP date strings (DATS/TIMS)` app = `z2ui5_cl_demo_app_450` )
      ...
      ( group = `Basic I` header = `Formatter` sub = `Inline Icons` app = `z2ui5_cl_demo_app_466` )
      ( group = `Basic I` header = `Formatter` sub = `Thin frontend, computed in ABAP` app = `z2ui5_cl_demo_app_453` )
      ( group = `Basic I` header = `Message` sub = `Backend Processing` app = `z2ui5_cl_smp_app_008` )
      ( group = `Basic I` header = `Message` sub = `Message Manager (C)` app = `z2ui5_cl_demo_app_467` )
      ( group = `Basic I` header = `Message` sub = `Message Model` app = `z2ui5_cl_demo_app_458` )
      ...
      ( group = `Basic I` header = `Model` sub = `Use OData models` app = `z2ui5_cl_demo_app_315` )
      ( group = `Basic I` header = `More` sub = `Error Handling` app = `z2ui5_cl_demo_app_464` )
      ( group = `Basic I` header = `More` sub = `File Download to the Frontend` app = `z2ui5_cl_demo_app_186` )
      ( group = `Basic I` header = `More` sub = `Generic Data Reference` app = `z2ui5_cl_demo_app_061` )
      ( group = `Basic I` header = `More` sub = `Link with preventDefault (A)` app = `z2ui5_cl_demo_app_472` )
      ( group = `Basic I` header = `More` sub = `Menu Item Path (A)` app = `z2ui5_cl_demo_app_473` )
      ...
      ( group = `Basic I` header = `Navigation` sub = `Call and leave to apps` app = `z2ui5_cl_demo_app_024` )
      ( group = `Basic I` header = `Navigation` sub = `Routing mode fresh` app = `z2ui5_cl_demo_app_468` )
      ( group = `Basic I` header = `Navigation` sub = `Routing mode keep` app = `z2ui5_cl_demo_app_480` )
      ...
      ( group = `Basic I` header = `Popover` sub = `Display Toggle (A)` app = `z2ui5_cl_demo_app_465` )
      ...
      ( group = `Basic I` header = `Popup` sub = `Aggregation binding to the selected row` app = `z2ui5_cl_demo_app_470` )
      ...
      ( group = `Basic I` header = `Scroll` sub = `Scroll into view (A)` app = `z2ui5_cl_demo_app_363` )
      ( group = `Basic I` header = `Scroll` sub = `Scroll to position (A)` app = `z2ui5_cl_demo_app_362` )
      ...
      ( group = `Basic I` header = `Timer` sub = `Loading Indicator with WAIT UP Backend (A)` app = `z2ui5_cl_demo_app_064` )
      ( group = `Basic I` header = `Timer` sub = `Wait n MS and call again the server (A)` app = `z2ui5_cl_demo_app_028` )
