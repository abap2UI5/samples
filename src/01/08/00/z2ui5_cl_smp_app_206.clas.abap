"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.Text/sample/sap.m.sample.TextMaxLines
"! The Text control has a property to limit the number of lines for wrapping texts.
CLASS z2ui5_cl_smp_app_206 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_206 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.Text/sample/sap.m.sample.TextMaxLines` ).
