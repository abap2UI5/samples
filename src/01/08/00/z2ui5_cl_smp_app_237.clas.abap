"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.Slider/sample/sap.m.sample.Slider
"! With the Slider a user can choose a value from a numerical range.
CLASS z2ui5_cl_smp_app_237 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_237 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.Slider/sample/sap.m.sample.Slider` ).
