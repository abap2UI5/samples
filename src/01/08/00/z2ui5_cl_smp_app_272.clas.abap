"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.ObjectHeader/sample/sap.m.sample.ObjectHeaderCircleImage
"! An Object Header can set shape of the image by using 'imageShape' property. The shapes could be
"! Square (by default) and Circle. Note: This example shows the image inside ObjectHeader with the
"! responsive property set to true. On phone in portrait mode, the image is hidden.
CLASS z2ui5_cl_smp_app_272 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_272 IMPLEMENTATION.
