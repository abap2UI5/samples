"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.RadioButtonGroup/sample/sap.m.sample.RadioButtonGroup
"! A wrapper for a group of radio buttons.
CLASS z2ui5_cl_smp_app_208 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_208 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.RadioButtonGroup/sample/sap.m.sample.RadioButtonGroup` ).
