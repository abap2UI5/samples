"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.RatingIndicator/sample/sap.m.sample.RatingIndicator
"! A Rating Indicator can be used to both indicate and/or rate content.
CLASS z2ui5_cl_smp_app_220 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_220 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.RatingIndicator/sample/sap.m.sample.RatingIndicator` ).
