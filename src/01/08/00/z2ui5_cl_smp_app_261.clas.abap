"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.NewsContent/sample/sap.m.sample.NewsContent
"! This control is used to display the news content text and subheader in a tile.
CLASS z2ui5_cl_smp_app_261 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_261 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    page->header_content(
                ...
                text   = `UI5 Demo Kit`
                target = `_blank`
                href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.NewsContent/sample/sap.m.sample.NewsContent` ).
