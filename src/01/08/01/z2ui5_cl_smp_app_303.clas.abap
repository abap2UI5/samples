"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.ObjectPageWithHeaderContainer
"! ObjectPage sample with Header Container
CLASS z2ui5_cl_smp_app_303 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_303 IMPLEMENTATION.
  ...
  METHOD z2ui5_if_app~main.
    ...
    DATA(object_page_layout) = view->shell(
                 ...
                 shownavbutton  = client->check_app_prev_stack( )
                    ...
                    text   = `UI5 Demo Kit`
                    target = `_blank`
                    href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.ObjectPageWithHeaderContainer`
            )->get_parent(
