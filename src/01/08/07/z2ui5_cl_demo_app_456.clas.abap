...
CLASS z2ui5_cl_demo_app_456 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    DATA(page) = z2ui5_cl_xml_view=>factory( )->shell(
            ...
            title          = `abap2UI5 - Sample: MultiInput Data Binding`
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.MultiInput/sample/sap.m.sample.MultiInputDatabinding` ).
