...
"! in the AnchorBar
CLASS z2ui5_cl_demo_app_532 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_demo_app_532 IMPLEMENTATION.

  METHOD view_display.

    DATA(page) = z2ui5_cl_xml_view=>factory( )->shell(
         )->page(
            title          = `abap2UI5 - Sample: Object Page AnchorBar with numbers`
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.AnchorBarWithNumbers` ).
