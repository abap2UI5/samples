...
CLASS z2ui5_cl_demo_app_424 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_demo_app_424 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    DATA(page) = z2ui5_cl_xml_view=>factory( )->shell(
            ...
            title          = `abap2UI5 - Sample: Combo box - Two columns layout`
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.ComboBox/sample/sap.m.sample.ComboBox2Columns` ).
