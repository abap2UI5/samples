...
CLASS z2ui5_cl_demo_app_476 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_demo_app_476 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    DATA(page) = view->shell(
            ...
            title          = `abap2UI5 - Sample: SelectList - with icons`
    ...
    page->header_content(
            ...
            text   = `UI5 Demo Kit`
            target = `_blank`
            href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.SelectList/sample/sap.m.sample.SelectListWithIcons` ).
