...
CLASS z2ui5_cl_smp_app_009 IMPLEMENTATION.
  ...
  METHOD on_event.
        DATA temp7 TYPE z2ui5_cl_smp_app_009=>ty_t_employee.
          FIELD-SYMBOLS <temp8> LIKE LINE OF t_employees_sel.
          DATA temp9 LIKE sy-tabix.
          FIELD-SYMBOLS <temp10> LIKE LINE OF t_employees_sel.
          DATA temp11 LIKE sy-tabix.
          FIELD-SYMBOLS <temp12> LIKE LINE OF t_suggestion_sel.
    ...
    CASE client->get_event( ).
      ...
      WHEN `POPUP_TABLE_VALUE_CUSTOM_CONTINUE`.
        ...
        IF lines( t_employees_sel ) = 1.
          ...
          temp9 = sy-tabix.
          READ TABLE t_employees_sel INDEX 1 ASSIGNING <temp8>.
          sy-tabix = temp9.
          IF sy-subrc <> 0.
            ASSERT 1 = 0.
          ENDIF.
          ...
          temp11 = sy-tabix.
          READ TABLE t_employees_sel INDEX 1 ASSIGNING <temp10>.
          sy-tabix = temp11.
          IF sy-subrc <> 0.
            ASSERT 1 = 0.
          ENDIF.
      ...
      WHEN `POPUP_TABLE_VALUE_CONTINUE`.
        ...
        IF lines( t_suggestion_sel ) = 1.
          ...
          temp13 = sy-tabix.
          READ TABLE t_suggestion_sel INDEX 1 ASSIGNING <temp12>.
          sy-tabix = temp13.
          IF sy-subrc <> 0.
            ASSERT 1 = 0.
          ENDIF.
