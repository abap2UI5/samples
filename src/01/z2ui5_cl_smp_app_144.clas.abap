...
CLASS Z2UI5_CL_SMP_APP_144 IMPLEMENTATION.
  ...
  METHOD set_view.
    ...
    FIELD-SYMBOLS <temp2> LIKE LINE OF t_tab.
    DATA temp3 LIKE sy-tabix.
    FIELD-SYMBOLS <temp4> LIKE LINE OF t_tab.
    DATA temp5 LIKE sy-tabix.
    FIELD-SYMBOLS <temp6> LIKE LINE OF t_tab.
    DATA temp7 LIKE sy-tabix.
    FIELD-SYMBOLS <temp8> LIKE LINE OF t_tab.
    ...
    temp3 = sy-tabix.
    READ TABLE t_tab INDEX 1 ASSIGNING <temp2>.
    sy-tabix = temp3.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp5 = sy-tabix.
    READ TABLE t_tab INDEX 1 ASSIGNING <temp4>.
    sy-tabix = temp5.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp7 = sy-tabix.
    READ TABLE t_tab INDEX 2 ASSIGNING <temp6>.
    sy-tabix = temp7.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp9 = sy-tabix.
    READ TABLE t_tab INDEX 2 ASSIGNING <temp8>.
    sy-tabix = temp9.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
