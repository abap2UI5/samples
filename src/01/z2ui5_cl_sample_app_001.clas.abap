...
CLASS z2ui5_cl_sample_app_001 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `controls - custom` header = `Action List Item` sub = `` app = `z2ui5_cl_demo_app_216` )
      ( group = `controls - custom` header = `Action Sheet` sub = `Choose an Action` app = `z2ui5_cl_demo_app_373` )
      ( group = `controls - custom` header = `Bar` sub = `Page, Toolbar & Bar` app = `z2ui5_cl_demo_app_227` )
      ( group = `controls - custom` header = `Bar` sub = `Toolbar vs Bar vs OverflowToolbar` app = `z2ui5_cl_demo_app_235` )
      ( group = `controls - custom` header = `Busy Indicator` sub = `` app = `z2ui5_cl_demo_app_215` )
      ( group = `controls - custom` header = `Card` sub = `with Header & Content` app = `z2ui5_cl_demo_app_181` )
      ( group = `controls - custom` header = `Carousel` sub = `Browse through Pages` app = `z2ui5_cl_demo_app_371` )
      ( group = `controls - custom` header = `Code Editor` sub = `editable with type switch` app = `z2ui5_cl_demo_app_035` )
      ( group = `controls - custom` header = `Code Editor` sub = `with hint popover` app = `z2ui5_cl_demo_app_265` )
      ( group = `controls - custom` header = `Color Picker` sub = `` app = `z2ui5_cl_demo_app_270` )
      ( group = `controls - custom` header = `ComboBox` sub = `Suggestions wrapping` app = `z2ui5_cl_demo_app_229` )
      ( group = `controls - custom` header = `Date Time Picker` sub = `Value States` app = `z2ui5_cl_demo_app_377` )
      ( group = `controls - custom` header = `Dynamic Page` sub = `Display items` app = `z2ui5_cl_demo_app_030` )
      ( group = `controls - custom` header = `Feed Input` sub = `` app = `z2ui5_cl_demo_app_101` )
      ( group = `controls - custom` header = `Feed Input` sub = `Icon Variants` app = `z2ui5_cl_demo_app_283` )
      ( group = `controls - custom` header = `Flex Box` sub = `Basic Alignment` app = `z2ui5_cl_demo_app_205` )
      ( group = `controls - custom` header = `Flex Box` sub = `Opposing Alignment` app = `z2ui5_cl_demo_app_218` )
      ( group = `controls - custom` header = `Flexible Column Layout` sub = `Master details with tree` app = `z2ui5_cl_demo_app_069` )
      ( group = `controls - custom` header = `Formatted Text` sub = `Display HTML` app = `z2ui5_cl_demo_app_015` )
      ...
      ( group = `controls - custom` header = `Grid List` sub = `with Drag&Drop` app = `z2ui5_cl_demo_app_307` )
      ( group = `controls - custom` header = `Icon Tab Bar` sub = `Filter Table with Counts` app = `z2ui5_cl_demo_app_368` )
      ( group = `controls - custom` header = `Icon Tab Bar` sub = `Icons Only` app = `z2ui5_cl_demo_app_221` )
      ( group = `controls - custom` header = `Icon Tab Bar` sub = `Inline Mode` app = `z2ui5_cl_demo_app_223` )
      ( group = `controls - custom` header = `Icon Tab Bar` sub = `Separator` app = `z2ui5_cl_demo_app_225` )
      ( group = `controls - custom` header = `Icon Tab Bar` sub = `Sub tabs` app = `z2ui5_cl_demo_app_226` )
      ( group = `controls - custom` header = `Icon Tab Bar` sub = `Text and Count` app = `z2ui5_cl_demo_app_222` )
      ( group = `controls - custom` header = `Icon Tab Bar` sub = `Text Only` app = `z2ui5_cl_demo_app_224` )
      ( group = `controls - custom` header = `Icon Tab Header` sub = `Standalone Icon Tab Header` app = `z2ui5_cl_demo_app_214` )
      ( group = `controls - custom` header = `Image` sub = `Sizing & Press Event` app = `z2ui5_cl_demo_app_379` )
      ( group = `controls - custom` header = `InfoLabel` sub = `` app = `z2ui5_cl_demo_app_209` )
      ( group = `controls - custom` header = `Input` sub = `Password` app = `z2ui5_cl_demo_app_213` )
      ( group = `controls - custom` header = `Input` sub = `Types` app = `z2ui5_cl_demo_app_210` )
      ( group = `controls - custom` header = `Input List Item` sub = `` app = `z2ui5_cl_demo_app_219` )
      ( group = `controls - custom` header = `Label` sub = `` app = `z2ui5_cl_demo_app_051` )
      ( group = `controls - custom` header = `LightBox` sub = `` app = `z2ui5_cl_demo_app_273` )
      ...
      ( group = `controls - custom` header = `Mask Input` sub = `` app = `z2ui5_cl_demo_app_110` )
      ( group = `controls - custom` header = `Menu Button` sub = `Regular & Split Mode` app = `z2ui5_cl_demo_app_372` )
      ( group = `controls - custom` header = `Message View` sub = `Custom Popup, Popover & Output` app = `z2ui5_cl_demo_app_038` )
      ( group = `controls - custom` header = `Multi Combo Box` sub = `Suggestions wrapping` app = `z2ui5_cl_demo_app_233` )
      ( group = `controls - custom` header = `Multi Input` sub = `Suggestions wrapping` app = `z2ui5_cl_demo_app_232` )
      ( group = `controls - custom` header = `Notification List Item` sub = `Priority & Close Button` app = `z2ui5_cl_demo_app_375` )
      ( group = `controls - custom` header = `Object Header` sub = `with Circle-shaped Image` app = `z2ui5_cl_demo_app_272` )
      ...
      ( group = `controls - custom` header = `Object Page` sub = `with Avatar (since 1.73)` app = `z2ui5_cl_demo_app_017` )
      ( group = `controls - custom` header = `Object Page` sub = `with Hidden Section Titles` app = `z2ui5_cl_demo_app_330` )
      ( group = `controls - custom` header = `Object Page Header` sub = `with Header Container` app = `z2ui5_cl_demo_app_303` )
      ( group = `controls - custom` header = `Overflow Toolbar` sub = `` app = `z2ui5_cl_demo_app_217` )
      ( group = `controls - custom` header = `Page` sub = `Header, Sub-Header & Footer` app = `z2ui5_cl_demo_app_366` )
      ( group = `controls - custom` header = `Panel` sub = `Expandable & Header Toolbar` app = `z2ui5_cl_demo_app_378` )
      ( group = `controls - custom` header = `Planning Calendar` sub = `` app = `z2ui5_cl_demo_app_080` )
      ( group = `controls - custom` header = `Progress Indicator` sub = `` app = `z2ui5_cl_demo_app_022` )
      ( group = `controls - custom` header = `Radio Button` sub = `` app = `z2ui5_cl_demo_app_207` )
      ( group = `controls - custom` header = `Radio Button Group` sub = `` app = `z2ui5_cl_demo_app_208` )
      ( group = `controls - custom` header = `Range Slider` sub = `` app = `z2ui5_cl_demo_app_005` )
      ( group = `controls - custom` header = `Rating Indicator` sub = `` app = `z2ui5_cl_demo_app_220` )
      ...
      ( group = `controls - custom` header = `Segmented Button` sub = `in Input List Item` app = `z2ui5_cl_demo_app_230` )
      ( group = `controls - custom` header = `Slide Tile` sub = `` app = `z2ui5_cl_demo_app_274` )
      ( group = `controls - custom` header = `Slider` sub = `` app = `z2ui5_cl_demo_app_237` )
      ( group = `controls - custom` header = `Split Container` sub = `Master & Detail Pages` app = `z2ui5_cl_demo_app_374` )
      ( group = `controls - custom` header = `Splitter Layout` sub = `Side Panel` app = `z2ui5_cl_demo_app_103` )
      ...
      ( group = `controls - custom` header = `Text` sub = `Max Lines` app = `z2ui5_cl_demo_app_206` )
      ( group = `controls - custom` header = `Text Area` sub = `` app = `z2ui5_cl_demo_app_021` )
      ( group = `controls - custom` header = `Text Area` sub = `Growing` app = `z2ui5_cl_demo_app_236` )
      ( group = `controls - custom` header = `Text Area` sub = `Value States` app = `z2ui5_cl_demo_app_234` )
      ( group = `controls - custom` header = `Tile` sub = `Feed and News Tile` app = `z2ui5_cl_demo_app_278` )
      ( group = `controls - custom` header = `Tile` sub = `Image Content` app = `z2ui5_cl_demo_app_271` )
      ( group = `controls - custom` header = `Tile` sub = `News Content` app = `z2ui5_cl_demo_app_261` )
      ( group = `controls - custom` header = `Tile` sub = `Numeric Content Without Margins` app = `z2ui5_cl_demo_app_228` )
      ( group = `controls - custom` header = `Tile` sub = `Statuses` app = `z2ui5_cl_demo_app_281` )
      ( group = `controls - custom` header = `Time Picker` sub = `Formats & Steps` app = `z2ui5_cl_demo_app_376` )
      ( group = `controls - custom` header = `Toggle Button` sub = `` app = `z2ui5_cl_demo_app_266` )
