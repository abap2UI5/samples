...
CLASS z2ui5_cl_sample_app_001 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `Basics` header = `Binding` sub = `Formatting Currencies` app = `z2ui5_cl_demo_app_067` )
      ...
      ( group = `Basics` header = `Event` sub = `Additional Infos with t_args` app = `z2ui5_cl_demo_app_167` )
      ...
      ( group = `Basics` header = `More` sub = `Error Handling` app = `z2ui5_cl_demo_app_464` )
      ...
      ( group = `Basics` header = `Templating` sub = `Basic Example` app = `z2ui5_cl_demo_app_173` )
      ...
      ( group = `Extended` header = `More` sub = `CameraSelector (C)` app = `z2ui5_cl_demo_app_306` )
      ( group = `Extended` header = `More` sub = `Data Loss Protection (C)` app = `z2ui5_cl_demo_app_279` )
      ( group = `Extended` header = `More` sub = `File Uploader (C)` app = `z2ui5_cl_demo_app_074` )
      ( group = `Extended` header = `More` sub = `Geoloaction (C)` app = `z2ui5_cl_demo_app_120` )
      ( group = `Extended` header = `More` sub = `Multi Input (C)` app = `z2ui5_cl_demo_app_078` )
      ( group = `Extended` header = `More` sub = `Panel, setExpanded (A)` app = `z2ui5_cl_demo_app_448` )
      ( group = `Extended` header = `More` sub = `PDF Viewer Display (A)` app = `z2ui5_cl_demo_app_449` )
      ( group = `Extended` header = `More` sub = `Wizard Control (A)` app = `z2ui5_cl_demo_app_202` )
      ( group = `Extended` header = `NavContainer` sub = `Popup (A)` app = `z2ui5_cl_demo_app_170` )
      ( group = `Extended` header = `NavContainer` sub = `Simple (A)` app = `z2ui5_cl_demo_app_088` )
