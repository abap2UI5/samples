...
CLASS z2ui5_cl_sample_app_001 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ( group = `Basics` header = `Action` sub = `control_call` app = `z2ui5_cl_demo_app_446` )
      ( group = `Basics` header = `Action` sub = `control_call_by_id` app = `z2ui5_cl_demo_app_447` )
      ( group = `Basics` header = `Binding` sub = `Expression Binding` app = `z2ui5_cl_demo_app_027` )
      ( group = `Basics` header = `Binding` sub = `Formatting Integers, Decimals, Dates & Time` app = `z2ui5_cl_demo_app_047` )
      ( group = `Basics` header = `Binding` sub = `Level Simple` app = `z2ui5_cl_demo_app_001` )
      ( group = `Basics` header = `Binding` sub = `Level Structure/Component` app = `z2ui5_cl_demo_app_166` )
      ( group = `Basics` header = `Binding` sub = `Level Table/Cell` app = `z2ui5_cl_demo_app_144` )
      ( group = `Basics` header = `Binding VII` sub = `Formatting Currencies` app = `z2ui5_cl_demo_app_067` )
      ( group = `Basics` header = `Event` sub = `Handle events & change the view` app = `z2ui5_cl_demo_app_004` )
      ( group = `Basics` header = `Event II` sub = `Additional Infos with t_args` app = `z2ui5_cl_demo_app_167` )
      ( group = `Basics` header = `Event III` sub = `Facet Filter - T_arg with Objects` app = `z2ui5_cl_demo_app_197` )
      ( group = `Basics` header = `Formatter` sub = `Date object minimal (DatePicker)` app = `z2ui5_cl_demo_app_457` )
      ( group = `Basics` header = `Formatter` sub = `Date objects for PlanningCalendar` app = `z2ui5_cl_demo_app_456` )
      ( group = `Basics` header = `Formatter` sub = `Simple` app = `z2ui5_cl_demo_app_453` )
      ( group = `Basics` header = `Formatter` sub = `weightState via core require` app = `z2ui5_cl_demo_app_450` )
      ( group = `Basics` header = `Message` sub = `Backend Processing` app = `z2ui5_cl_demo_app_008` )
      ( group = `Basics` header = `Message` sub = `MessageBox` app = `z2ui5_cl_demo_app_382` )
      ( group = `Basics` header = `Message` sub = `MessageToast` app = `z2ui5_cl_demo_app_381` )
      ( group = `Basics` header = `Message` sub = `MessageView` app = `z2ui5_cl_demo_app_452` )
      ( group = `Basics` header = `Model` sub = `Device Model in views and popups` app = `z2ui5_cl_demo_app_445` )
      ( group = `Basics` header = `Model` sub = `Message Model` app = `z2ui5_cl_demo_app_458` )
      ( group = `Basics` header = `Model` sub = `Set Size Limit` app = `z2ui5_cl_demo_app_071` )
      ( group = `Basics` header = `More` sub = `Call and leave to apps` app = `z2ui5_cl_demo_app_024` )
      ( group = `Basics` header = `More` sub = `Generic Data Reference` app = `z2ui5_cl_demo_app_061` )
      ( group = `Basics` header = `More` sub = `Read Frontend Infos` app = `z2ui5_cl_demo_app_122` )
      ( group = `Basics` header = `More` sub = `Require Object in XML View` app = `z2ui5_cl_demo_app_163` )
      ( group = `Basics` header = `Nested Views` sub = `Head & Item Table` app = `z2ui5_cl_demo_app_097` )
      ( group = `Basics` header = `Nested Views` sub = `Head & Item Table & Detail` app = `z2ui5_cl_demo_app_098` )
      ( group = `Basics` header = `Nested Views` sub = `Sub-App` app = `z2ui5_cl_demo_app_104` )
      ( group = `Basics` header = `Nested Views I` sub = `Basic Example` app = `z2ui5_cl_demo_app_065` )
      ( group = `Basics` header = `Popover` sub = `Item Level of Table` app = `z2ui5_cl_demo_app_052` )
      ( group = `Basics` header = `Popover` sub = `List to select in Popover` app = `z2ui5_cl_demo_app_081` )
      ( group = `Basics` header = `Popover` sub = `Simple Example` app = `z2ui5_cl_demo_app_026` )
      ( group = `Basics` header = `Popover` sub = `with Quick View` app = `z2ui5_cl_demo_app_109` )
      ( group = `Basics` header = `Popup` sub = `Different ways of calling Popups` app = `z2ui5_cl_demo_app_012` )
      ( group = `Basics` header = `Popup` sub = `Popup in Popup - Backend Stack Handling` app = `z2ui5_cl_demo_app_161` )
      ( group = `Basics` header = `Popup` sub = `Value Help with Popups` app = `z2ui5_cl_demo_app_009` )
      ( group = `Basics` header = `Templating` sub = `Nested Views` app = `z2ui5_cl_demo_app_176` )
      ( group = `Basics` header = `Templating I` sub = `Basic Example` app = `z2ui5_cl_demo_app_173` )
      ( group = `Extended` header = `A Nav Container` sub = `Popup` app = `z2ui5_cl_demo_app_170` )
      ( group = `Extended` header = `A Wizard Control` sub = `` app = `z2ui5_cl_demo_app_202` )
      ( group = `Extended` header = `Action` sub = `Panel, setExpanded (A)` app = `z2ui5_cl_demo_app_448` )
      ( group = `Extended` header = `Action` sub = `PDF Viewer Display (A)` app = `z2ui5_cl_demo_app_449` )
      ( group = `Extended` header = `Browser` sub = `Logout (A)` app = `z2ui5_cl_demo_app_361` )
      ( group = `Extended` header = `Browser` sub = `Title` app = `z2ui5_cl_demo_app_125` )
      ( group = `Extended` header = `CC CameraSelector` sub = `` app = `z2ui5_cl_demo_app_306` )
      ( group = `Extended` header = `CC Data loss protection` sub = `` app = `z2ui5_cl_demo_app_279` )
      ( group = `Extended` header = `Custom Control` sub = `File Uploader (C)` app = `z2ui5_cl_demo_app_074` )
      ( group = `Extended` header = `Custom Control` sub = `Geoloaction` app = `z2ui5_cl_demo_app_120` )
      ( group = `Extended` header = `Custom Control` sub = `Multi Input (C)` app = `z2ui5_cl_demo_app_078` )
      ( group = `Extended` header = `Custom Control` sub = `Nav Container` app = `z2ui5_cl_demo_app_088` )
      ( group = `Extended` header = `Error Handling` sub = `unexpected error popup` app = `z2ui5_cl_demo_app_464` )
      ( group = `Extended` header = `Focus I` sub = `Set Focus in Textfield` app = `z2ui5_cl_demo_app_133` )
      ( group = `Extended` header = `Focus II` sub = `Jump with the focus` app = `z2ui5_cl_demo_app_189` )
      ( group = `Extended` header = `Input` sub = `Clipboard` app = `z2ui5_cl_demo_app_325` )
      ( group = `Extended` header = `Input` sub = `Hide/show Soft Keyboard` app = `z2ui5_cl_demo_app_352` )
      ( group = `Extended` header = `List` sub = `Events & Visualization` app = `z2ui5_cl_demo_app_048` )
      ( group = `Extended` header = `List` sub = `Filter and sort via backend event (A)` app = `z2ui5_cl_demo_app_454` )
      ( group = `Extended` header = `List` sub = `Live filter without backend (A)` app = `z2ui5_cl_demo_app_455` )
      ( group = `Extended` header = `Scroll I` sub = `Scroll to position` app = `z2ui5_cl_demo_app_362` )
      ( group = `Extended` header = `Scroll II` sub = `Scroll into view` app = `z2ui5_cl_demo_app_363` )
      ( group = `Extended` header = `Table` sub = `Backend Filter` app = `z2ui5_cl_demo_app_045` )
      ( group = `Extended` header = `Table` sub = `Drag and Drop (A)` app = `z2ui5_cl_demo_app_459` )
      ( group = `Extended` header = `Table` sub = `Editable` app = `z2ui5_cl_demo_app_011` )
      ( group = `Extended` header = `Table` sub = `Search Backend` app = `z2ui5_cl_demo_app_053` )
      ( group = `Extended` header = `Table` sub = `Search Backend Live` app = `z2ui5_cl_demo_app_059` )
      ( group = `Extended` header = `Table` sub = `Selection Modes: Single Select & Multi Select` app = `z2ui5_cl_demo_app_019` )
      ( group = `Extended` header = `Table` sub = `Table with ScrollContainer` app = `z2ui5_cl_demo_app_006` )
      ( group = `Extended` header = `Timer I` sub = `Wait n MS and call again the server` app = `z2ui5_cl_demo_app_028` )
      ( group = `Extended` header = `Timer II` sub = `Loading Indicator with WAIT UP Backend` app = `z2ui5_cl_demo_app_064` )
      ( group = `Extended` header = `Tree` sub = `Drag and Drop` app = `z2ui5_cl_demo_app_461` )
      ( group = `Extended` header = `Tree` sub = `Editable with Custom Item (C)` app = `z2ui5_cl_demo_app_463` )
      ( group = `Extended` header = `Tree` sub = `Inside Popup (C)` app = `z2ui5_cl_demo_app_462` )
      ( group = `Extended` header = `Tree` sub = `Simple` app = `z2ui5_cl_demo_app_460` )
      ( group = `Extended` header = `ui.Table` sub = `Default Filtering` app = `z2ui5_cl_demo_app_143` )
      ( group = `Extended` header = `ui.Table` sub = `Events on Cell Level` app = `z2ui5_cl_demo_app_160` )
      ( group = `Extended` header = `ui.Table` sub = `Full Example` app = `z2ui5_cl_demo_app_070` )
      ( group = `Extended` header = `URL I` sub = `New Tab Open an URL in a new tab` app = `z2ui5_cl_demo_app_073` )
      ( group = `Extended` header = `URL II` sub = `Open Telephon, Email usw` app = `z2ui5_cl_demo_app_316` )
