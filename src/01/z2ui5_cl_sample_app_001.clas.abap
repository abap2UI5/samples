...
CLASS z2ui5_cl_sample_app_001 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ( group = `framework - basics` header = `Binding` sub = `Level Simple` app = `z2ui5_cl_demo_app_001` )
      ...
      ( group = `framework - basics` header = `Event` sub = `Handle events & change the view` app = `z2ui5_cl_demo_app_004` )
      ...
      ( group = `framework - basics` header = `Formatter` sub = `Date object minimal (DatePicker)` app = `z2ui5_cl_demo_app_457` )
      ( group = `framework - basics` header = `Formatter` sub = `Date objects for PlanningCalendar` app = `z2ui5_cl_demo_app_456` )
      ( group = `framework - basics` header = `Formatter` sub = `Simple` app = `z2ui5_cl_demo_app_453` )
      ( group = `framework - basics` header = `Formatter` sub = `weightState via core require` app = `z2ui5_cl_demo_app_450` )
      ( group = `framework - basics` header = `Message` sub = `Backend Processing` app = `z2ui5_cl_demo_app_008` )
      ...
      ( group = `framework - basics` header = `Model` sub = `Device Model in views and popups` app = `z2ui5_cl_demo_app_445` )
      ( group = `framework - basics` header = `Model` sub = `Message Model` app = `z2ui5_cl_demo_app_458` )
      ( group = `framework - basics` header = `ModelMore` sub = `Set Size Limit` app = `z2ui5_cl_demo_app_071` )
      ...
      ( group = `framework - basics` header = `Popover` sub = `Item Level of Table` app = `z2ui5_cl_demo_app_052` )
      ( group = `framework - basics` header = `Popover` sub = `List to select in Popover` app = `z2ui5_cl_demo_app_081` )
      ( group = `framework - basics` header = `Popover` sub = `Simple Example` app = `z2ui5_cl_demo_app_026` )
      ( group = `framework - basics` header = `Popover IV` sub = `with Quick View` app = `z2ui5_cl_demo_app_109` )
      ( group = `framework - basics` header = `Popup` sub = `Different ways of calling Popups` app = `z2ui5_cl_demo_app_012` )
      ( group = `framework - basics` header = `Popup` sub = `Value Help with Popups` app = `z2ui5_cl_demo_app_009` )
      ...
      ( group = `framework - use cases` header = `A Nav Container` sub = `` app = `z2ui5_cl_demo_app_088` )
      ( group = `framework - use cases` header = `A Nav Container` sub = `Popup` app = `z2ui5_cl_demo_app_170` )
      ( group = `framework - use cases` header = `A Wizard Control` sub = `` app = `z2ui5_cl_demo_app_202` )
      ( group = `framework - use cases` header = `Action` sub = `control_call` app = `z2ui5_cl_demo_app_446` )
      ( group = `framework - use cases` header = `Action` sub = `control_call_by_id` app = `z2ui5_cl_demo_app_447` )
      ( group = `framework - use cases` header = `Action` sub = `Panel, setExpanded (A)` app = `z2ui5_cl_demo_app_448` )
      ( group = `framework - use cases` header = `Action` sub = `PDF Viewer Display (A)` app = `z2ui5_cl_demo_app_449` )
      ( group = `framework - use cases` header = `Browser` sub = `Logout` app = `z2ui5_cl_demo_app_361` )
      ( group = `framework - use cases` header = `Browser` sub = `Title` app = `z2ui5_cl_demo_app_125` )
      ( group = `framework - use cases` header = `C File Uploader` sub = `` app = `z2ui5_cl_demo_app_074` )
      ( group = `framework - use cases` header = `C Geoloaction` sub = `` app = `z2ui5_cl_demo_app_120` )
      ( group = `framework - use cases` header = `C Multi Input` sub = `` app = `z2ui5_cl_demo_app_078` )
      ( group = `framework - use cases` header = `CC CameraSelector` sub = `` app = `z2ui5_cl_demo_app_306` )
      ( group = `framework - use cases` header = `CC Data loss protection` sub = `` app = `z2ui5_cl_demo_app_279` )
      ( group = `framework - use cases` header = `Error Handling` sub = `unexpected error popup` app = `z2ui5_cl_demo_app_464` )
      ( group = `framework - use cases` header = `Focus I` sub = `Set Focus in Textfield` app = `z2ui5_cl_demo_app_133` )
      ( group = `framework - use cases` header = `Focus II` sub = `Jump with the focus` app = `z2ui5_cl_demo_app_189` )
      ( group = `framework - use cases` header = `Input` sub = `Clipboard` app = `z2ui5_cl_demo_app_325` )
      ( group = `framework - use cases` header = `Input` sub = `Hide/show Soft Keyboard` app = `z2ui5_cl_demo_app_352` )
      ( group = `framework - use cases` header = `List` sub = `Events & Visualization` app = `z2ui5_cl_demo_app_048` )
      ( group = `framework - use cases` header = `List` sub = `Filter and sort via backend event (A)` app = `z2ui5_cl_demo_app_454` )
      ( group = `framework - use cases` header = `List` sub = `Live filter without backend (A)` app = `z2ui5_cl_demo_app_455` )
      ( group = `framework - use cases` header = `m.Table` sub = `Search Backend Live` app = `z2ui5_cl_demo_app_059` )
      ( group = `framework - use cases` header = `Scroll I` sub = `Scroll to position` app = `z2ui5_cl_demo_app_362` )
      ( group = `framework - use cases` header = `Scroll II` sub = `Scroll into view` app = `z2ui5_cl_demo_app_363` )
      ( group = `framework - use cases` header = `Table` sub = `Backend Filter` app = `z2ui5_cl_demo_app_045` )
      ( group = `framework - use cases` header = `Table` sub = `Drag and Drop (A)` app = `z2ui5_cl_demo_app_459` )
      ( group = `framework - use cases` header = `Table` sub = `Editable` app = `z2ui5_cl_demo_app_011` )
      ( group = `framework - use cases` header = `Table` sub = `Search Backend` app = `z2ui5_cl_demo_app_053` )
      ( group = `framework - use cases` header = `Table` sub = `Selection Modes: Single Select & Multi Select` app = `z2ui5_cl_demo_app_019` )
      ( group = `framework - use cases` header = `Table` sub = `Table with ScrollContainer` app = `z2ui5_cl_demo_app_006` )
      ( group = `framework - use cases` header = `Timer I` sub = `Wait n MS and call again the server` app = `z2ui5_cl_demo_app_028` )
      ( group = `framework - use cases` header = `Timer II` sub = `Loading Indicator with WAIT UP Backend` app = `z2ui5_cl_demo_app_064` )
      ( group = `framework - use cases` header = `Tree` sub = `Drag and Drop` app = `z2ui5_cl_demo_app_461` )
      ( group = `framework - use cases` header = `Tree` sub = `Editable with Custom Item (C)` app = `z2ui5_cl_demo_app_463` )
      ( group = `framework - use cases` header = `Tree` sub = `Inside Popup (C)` app = `z2ui5_cl_demo_app_462` )
      ( group = `framework - use cases` header = `Tree` sub = `Simple` app = `z2ui5_cl_demo_app_460` )
      ( group = `framework - use cases` header = `ui.Table` sub = `Default Filtering` app = `z2ui5_cl_demo_app_143` )
      ( group = `framework - use cases` header = `ui.Table` sub = `Events on Cell Level` app = `z2ui5_cl_demo_app_160` )
      ( group = `framework - use cases` header = `ui.Table` sub = `Full Example` app = `z2ui5_cl_demo_app_070` )
      ( group = `framework - use cases` header = `URL I` sub = `New Tab Open an URL in a new tab` app = `z2ui5_cl_demo_app_073` )
      ( group = `framework - use cases` header = `URL II` sub = `Open Telephon, Email usw` app = `z2ui5_cl_demo_app_316` )
