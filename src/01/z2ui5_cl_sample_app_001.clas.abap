...
CLASS z2ui5_cl_sample_app_001 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `framework - basics` header = `Message` sub = `Message Model` app = `z2ui5_cl_demo_app_458` )
      ...
      ( group = `framework - action` header = `Formatter` sub = `Date object minimal (DatePicker)` app = `z2ui5_cl_demo_app_457` )
      ( group = `framework - action` header = `Formatter` sub = `Date objects for PlanningCalendar` app = `z2ui5_cl_demo_app_456` )
      ( group = `framework - action` header = `Formatter` sub = `demo kit pack` app = `z2ui5_cl_demo_app_453` )
      ( group = `framework - action` header = `Formatter` sub = `weightState via core require` app = `z2ui5_cl_demo_app_450` )
      ...
      ( group = `framework - use cases` header = `sap.m.Table` sub = `Drag and Drop` app = `z2ui5_cl_demo_app_459` )
      ...
      ( group = `framework - use cases` header = `sap.m.Tree` sub = `` app = `z2ui5_cl_demo_app_460` )
      ( group = `framework - use cases` header = `sap.m.Tree` sub = `Drag and Drop` app = `z2ui5_cl_demo_app_461` )
