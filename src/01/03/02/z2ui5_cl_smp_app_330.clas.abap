"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.ObjectPageSectionShowTitle
"! ObjectPage sample that demonstrates the combination of header facets and showTitle properties of
"! sections and subsections.
CLASS z2ui5_cl_smp_app_330 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_330 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    DATA(object_page_layout) = view->shell(
                 ...
                 shownavbutton  = client->check_app_prev_stack( )
                    ...
                    text   = `UI5 Demo Kit`
                    target = `_blank`
                    href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.ObjectPageSectionShowTitle`
            )->get_parent(
