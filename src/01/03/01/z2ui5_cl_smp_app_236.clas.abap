"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.TextArea/sample/sap.m.sample.TextAreaGrowing
"! Since 1.38 the growing property of sap.m.TextArea gives the ability of a control to automatically
"! grow and shrink dynamically with its content.
CLASS z2ui5_cl_smp_app_236 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_236 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.TextArea/sample/sap.m.sample.TextAreaGrowing` ).
