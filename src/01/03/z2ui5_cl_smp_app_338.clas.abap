CLASS z2ui5_cl_smp_app_338 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_338 IMPLEMENTATION.
  ...
  METHOD on_init.
    ...
    mt_t002 = VALUE #( ( id = `1` class = `Z2UI5_CL_SMP_APP_339` table = `Z2UI5_T_01` )
                       ( id = `2` class = `Z2UI5_CL_SMP_APP_342` table = `Z2UI5_T_01` )
                       ( id = `3` class = `Z2UI5_CL_SMP_APP_339` table = `Z2UI5_T_01` ) ).
