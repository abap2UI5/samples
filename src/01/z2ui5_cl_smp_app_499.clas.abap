...
CLASS z2ui5_cl_smp_app_499 IMPLEMENTATION.
  ...
  METHOD on_event.
        ...
        DATA temp11 TYPE string_table.
          ...
          DATA temp1 LIKE LINE OF temp13.
    ...
    CASE client->get_event( ).
      ...
      WHEN `GO_MAIN`.
        ...
        INSERT `page-main` INTO TABLE temp9.
        client->follow_up_action( val   = client->cs_event-control_by_id
                                  t_arg = temp9 ).
      ...
      WHEN `HASH_CHANGED`.
        ...
        IF check_detail = abap_true AND client->get( )-s_config-hash <> |/detail/{ variant }|.
          ...
          temp1 = |/detail/{ variant }|.
          INSERT temp1 INTO TABLE temp13.
        ...
        ELSE.
          temp2 = `page-main`.
        ENDIF.
        INSERT temp2 INTO TABLE temp15.
        client->follow_up_action( val   = client->cs_event-control_by_id
                                  t_arg = temp15 ).
