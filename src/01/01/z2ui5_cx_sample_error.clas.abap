CLASS z2ui5_cx_sample_error DEFINITION
  PUBLIC
...
CLASS z2ui5_cx_sample_error IMPLEMENTATION.
  METHOD constructor ##ADT_SUPPRESS_GENERATION.
    ...
    TRY.
      ...
      CATCH cx_root.
        ms_error-text = val.
    ENDTRY.
    ms_error-uuid = z2ui5_cl_sample_context=>uuid_get_c32( ).
  ...
  METHOD if_message~get_text.
    ...
    IF previous IS BOUND.
      DATA(lo_x) = previous.
      WHILE lo_x IS BOUND.
        result = result && z2ui5_cl_sample_context=>cv_char_util_newline && lo_x->get_text( ).
        lo_x = lo_x->previous.
      ENDWHILE.
    ENDIF.
