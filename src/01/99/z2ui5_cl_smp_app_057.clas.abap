CLASS z2ui5_cl_smp_app_057 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_057 IMPLEMENTATION.
  ...
  METHOD view_display_main.
    ...
    IF mv_check_download = abap_true.
      ...
      DATA(lv_csv) = z2ui5_cl_smp_context=>itab_get_csv_by_itab( mt_table ).
      DATA(lv_csv_x) = z2ui5_cl_smp_context=>conv_get_xstring_by_string( lv_csv ).
      DATA(lv_base64) = z2ui5_cl_smp_context=>conv_encode_x_base64( lv_csv_x ).
