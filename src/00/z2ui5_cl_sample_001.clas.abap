...
CLASS z2ui5_cl_sample_001 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_305` sub = `Cell Coloring` app = `z2ui5_cl_demo_app_305` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_050` sub = `Change CSS - Send your own CSS to the frontend` app = `z2ui5_cl_demo_app_050` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_141` sub = `custom function in popup` app = `z2ui5_cl_demo_app_141` )
      ...
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_093` sub = `ext - call custom function` app = `z2ui5_cl_demo_app_093` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_036` sub = `extension - canvas and svg` app = `z2ui5_cl_demo_app_036` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_037` sub = `extension - custom control` app = `z2ui5_cl_demo_app_037` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_040` sub = `extension - ext library` app = `z2ui5_cl_demo_app_040` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_032` sub = `extension - html css js` app = `z2ui5_cl_demo_app_032` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_256` sub = `Fix Flex - Fix container size` app = `z2ui5_cl_demo_app_256` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_253` sub = `Flex Box - Equal Height Cols` app = `z2ui5_cl_demo_app_253` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_255` sub = `Flex Box - Navigation Examples` app = `z2ui5_cl_demo_app_255` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_254` sub = `Flex Box - Nested` app = `z2ui5_cl_demo_app_254` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_244` sub = `Flex Box - Size Adjustments` app = `z2ui5_cl_demo_app_244` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_309` sub = `follow_up_action with JS` app = `z2ui5_cl_demo_app_309` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_309_0` sub = `follow_up_action with JS` app = `z2ui5_cl_demo_app_309_0` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_268` sub = `Icon` app = `z2ui5_cl_demo_app_268` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_084` sub = `Message Box & Input Functions` app = `z2ui5_cl_demo_app_084` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_310` sub = `Messages with Styles I` app = `z2ui5_cl_demo_app_310` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_311` sub = `Messages with Styles II` app = `z2ui5_cl_demo_app_311` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_090` sub = `popups - p13n Dialog` app = `z2ui5_cl_demo_app_090` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_111` sub = `selscreen - filter bar with variant managment WIP` app = `z2ui5_cl_demo_app_111` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_352_0` sub = `Softkeyboard on/off` app = `z2ui5_cl_demo_app_352_0` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_346` sub = `tab - focus edit controls` app = `z2ui5_cl_demo_app_346` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_277` sub = `Tile - KPI Tile` app = `z2ui5_cl_demo_app_277` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_317` sub = `tree - drag & drop` app = `z2ui5_cl_demo_app_317` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_178` sub = `tree - popup select - state` app = `z2ui5_cl_demo_app_178` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_116` sub = `tree table - save expand state` app = `z2ui5_cl_demo_app_116` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_060` sub = `ui - suggestion` app = `z2ui5_cl_demo_app_060` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_201` sub = `ui - suggestion with CC filtering` app = `z2ui5_cl_demo_app_201` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_172` sub = `ui table - focus handling` app = `z2ui5_cl_demo_app_172` )
      ( group = `only with javascript and css and html` header = `z2ui5_cl_demo_app_202_0` sub = `wizard - nextStep & subsequentSteps` app = `z2ui5_cl_demo_app_202_0` )
      ...
      ( group = `experimental` header = `UploadSet` sub = `Custom Control` app = `z2ui5_cl_demo_app_354` )
