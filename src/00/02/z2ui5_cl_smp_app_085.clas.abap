CLASS z2ui5_cl_smp_app_085 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_085 IMPLEMENTATION.
...
*    https://sapui5.hana.ondemand.com/sdk/#/topic/3b9f760da5b64adf8db7f95247879086
    CASE client->get( )-event.
      WHEN `ONGOTOSUPPLIER`.
        DATA(lo_app_next) = NEW z2ui5_cl_smp_app_086( ).
      ...
      WHEN `ONPRESSSUPPLIER`.
        ...
        lo_app_next = NEW z2ui5_cl_smp_app_086( ).
        lo_app_next->ls_detail_supplier = ls_detail_supplier.
        client->nav_app_call( lo_app_next ).
      WHEN `ONPRESSMASTER`.
