"! Rebuild of the UI5 demo kit sample: https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.ActionSheet/sample/sap.m.sample.ActionSheet
"! Action Sheet provides an easier way of showing a list of actions and allowing the user to select
"! one. Title and Cancel button can be shown or hidden. Without an icon the entry will be left-aligned
"! (see the last action in the list).
CLASS z2ui5_cl_smp_app_373 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smp_app_373 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    page->header_content(
           ...
           text   = `UI5 Demo Kit`
           target = `_blank`
           href   = `https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.ActionSheet/sample/sap.m.sample.ActionSheet` ).
