...
CLASS z2ui5_cl_sample_app_g01 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `extended` header = `Smart Controls` sub = `Page Variant Management` app = `z2ui5_cl_demo_app_478` )
      ( group = `extended` header = `Smart Controls` sub = `SmartChart with NavPopover` app = `z2ui5_cl_demo_app_479` )
      ( group = `extended` header = `Smart Controls` sub = `SmartField in a SmartForm` app = `z2ui5_cl_demo_app_475` )
      ( group = `extended` header = `Smart Controls` sub = `SmartFilterBar and SmartTable` app = `z2ui5_cl_demo_app_477` )
      ( group = `extended` header = `Smart Controls` sub = `SmartForm, editable toggle` app = `z2ui5_cl_demo_app_476` )
