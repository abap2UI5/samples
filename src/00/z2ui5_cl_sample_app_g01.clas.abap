...
CLASS z2ui5_cl_sample_app_g01 IMPLEMENTATION.
  ...
  METHOD get_catalog.
    ...
    result = VALUE #(
      ...
      ( group = `restricted - release - version` header = `Sample App` sub = `Full View` app = `z2ui5_cl_demo_app_085` )
      ( group = `restricted - release - version` header = `Sample App` sub = `Selection Screen` app = `z2ui5_cl_demo_app_002` )
