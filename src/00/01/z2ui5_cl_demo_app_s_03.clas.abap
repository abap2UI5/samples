  ...
  METHOD on_event.
    ...
    IF client->get( )-event = `enter`.
      ...
      IF magic_key = `abap2UI5`.
        client->follow_up_action( |.eF('PLAY_AUDIO', '/SAP/PUBLIC/BC/ABAP/mime_demo/z2ui5_demo_success.mp3')| ).
        message-type = `Success`.
        message-text = `Hooray!`.

      ELSE.
        client->follow_up_action( |.eF('PLAY_AUDIO', '/SAP/PUBLIC/BC/ABAP/mime_demo/z2ui5_demo_error.mp3')| ).
        message-type = `Error`.
