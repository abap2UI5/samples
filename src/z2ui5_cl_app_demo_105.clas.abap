class Z2UI5_CL_APP_DEMO_105 definition
  public
  create public .
...
CLASS Z2UI5_CL_APP_DEMO_105 IMPLEMENTATION.
  ...
  METHOD z2ui5_if_app~main.
    ...
    IF mv_check_popup = abap_true.
      ...
      DATA(app) = CAST Z2UI5_CL_APP_DEMO_104( client->get_app( client->get( )-s_draft-id_prev_app )  ).
  ...
  METHOD z2ui5_on_event.
    ...
    CASE ir_client->get( )-event.
      WHEN `FILTER_VALUE_HELP`.
        ...
        ir_client->nav_app_call( z2ui5_cl_app_demo_104=>factory(
