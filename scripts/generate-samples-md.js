 ...
 * (scripts/lib/scan-samples.js), so the two can never disagree.
 *
 ...
 * left it stale.
 *
 * No dependencies. Run:  node scripts/generate-samples-md.js
 */
'use strict';
...
const page = `<!-- Generated by scripts/generate-samples-md.js. Do not edit by hand:
     run \`npm run launchpad\` and commit the result (AGENTS.md section 4). -->

# The sample catalogue

Every app in this repository — ${total} of them — with what it shows and a link
