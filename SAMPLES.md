...
| Menu Button with core:require<br>A MenuButton whose items call a UI5 module loaded with core:require, so the click is answered in the frontend.<br><sub>menubutton menuitem popover messagetoast require module</sub> | [`Z2UI5_CL_SMP_APP_163`](src/z2ui5_cl_smp_app_163.clas.abap) |
...
| Large Table with Growing and ScrollContainer<br>10.000 rows in one table: growing, a sticky toolbar and sorting - and what that costs on the way to the browser.<br><sub>growing 10000 rows sticky toolbar sort performance</sub><br><sub>docs: [cookbook/model/tables](https://abap2ui5.github.io/docs/cookbook/model/tables)</sub> | [`Z2UI5_CL_SMP_APP_006`](src/z2ui5_cl_smp_app_006.clas.abap) |
