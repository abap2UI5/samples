...
`Z2UI5_CL_SMP_APP_000` and click through the 99 samples below —
...
The **99 ready-to-run samples** the README leads with, and the
...
overview app itself, that is 106 apps on every branch.
